...
# If NOT in training mode, load a previously trained model and change the epsilon values for exploration. 
if not SHOULD_TRAIN:
    folder_name = ""
    ckpt_name = ""
...
for i in range(NUM_OF_EPISODES):    
    ...
    # this will save your model after every CKPT_SAVE_INTERVAL many episodes. Can change it above. 
